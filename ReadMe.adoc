...
Alexa treats this table as a dimmable light. A given brightness percentage represents a drink 
selection or a command for the table to execute.  

https://github.com/user-attachments/assets/83653fed-f806-43cc-ba11-e9e344582d79  
...
For the CAD files and 3D-printed parts used in this project, refer to the 
https://github.com/DarrenSeubert/DrinkTable/tree/main/CADFiles[CADFiles] folder.  
...
=== Disclaimers  
- DO NOT keep liquids that need to be refrigerated or closed inside of the table after opening for 
an extended period of time. This could lead to bacteria and mold growth.
- The current setup tends to leave a plastic-like taste in the liquids poured. I was unable to 
identify a root cause for this issue, and I am uncertain about how serious the concern may be.
