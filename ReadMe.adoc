...
=== Disclaimers  
- DO NOT keep liquids that need to be refrigerated or closed inside the table after opening for an 
extended period of time. This could lead to bacteria and mold growth.
