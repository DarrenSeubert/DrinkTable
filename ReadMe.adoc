...
3. Create a Cloud Varaiable named drinkSelection and configure it as a Dimmed light, Read & Write, and On change
...
4. Set up routintes for what phrases mean what drink should be made or action
...
Follow this encodeURI('https://docs.google.com/spreadsheets/d/1IcMglOSQPUuBVhDI59dvtKw1fak_Vcd6wv3FlI9-fAY/edit?usp=sharing:"link"') to check out the BOM for this project.
Here is a encodeURI('https://google.com:"link"') to all of the parts 3D printed for this project.
